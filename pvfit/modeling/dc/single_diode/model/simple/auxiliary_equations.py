"""
PVfit: Simple auxiliary equations for single-diode model (SDM).
...
def compute_sde_model_parameters(
    *,
    ...
    """
    Computes "simple" auxiliary equations at the specified effective irradiance ratio
    and cell temperature and model parameters, producing model parameters for SDE.
