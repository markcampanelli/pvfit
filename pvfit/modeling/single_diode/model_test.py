...
@pytest.fixture(
    ...
    params=[{
        ...
        'V_1_V_expected': numpy.array([0.5, 0., 0.]),
...
def test_current_sum_at_diode_node(current_sum_at_diode_node_fixture):
    ...
    result = model.current_sum_at_diode_node(
        V_V=V_V, I_A=I_A, F=F, T_degC=T_degC, N_s=N_s, T_degC_0=T_degC_0, I_sc_A_0=I_sc_A_0, I_rs_1_A_0=I_rs_1_A_0, n_1_0=n_1_0,
...
@pytest.fixture(
    ...
    params=[{  # Can handle all python scalar inputs.
        ...
        'I_rs_1_A_expected': numpy.float64(6.e-7),
