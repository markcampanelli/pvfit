...
def test_materials():
    ...
    assert isinstance(common.MATERIALS_INFO[common.Material.monoSi].E_g_eV_stc, float)
    numpy.testing.assert_array_equal(
        common.MATERIALS_INFO[common.Material.monoSi].E_g_eV_stc, 1.121
    )

    assert isinstance(common.MATERIALS_INFO[common.Material.multiSi].E_g_eV_stc, float)
    numpy.testing.assert_array_equal(
        common.MATERIALS_INFO[common.Material.multiSi].E_g_eV_stc, 1.121
    )

    assert isinstance(common.MATERIALS_INFO[common.Material.polySi].E_g_eV_stc, float)
    numpy.testing.assert_array_equal(
